		...
		>
			...
			>
				...
				<div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
					...
					<span>
						{mod.updated_at ? timeAgo(mod.updated_at, t) : t("modCard.no_date")}
					</span>
				</div>
					...
					{mod.downloads > 0 && (
						<div style={{ display: "flex", alignItems: "center", gap: "3px" }}>
							<svg
								...
								viewBox="0 0 16 16"
								fill="currentColor"
								aria-label={t("modCard.downloads")}
							>
								<path
									stroke="none"
					...
					{mod.approval_pct >= 0 && (
						<div style={{ display: "flex", alignItems: "center", gap: "3px" }}>
							<svg
								...
								width="13"
								height="13"
								viewBox="0 0 471.1 474"
								fill="currentColor"
								aria-label={t("modCard.approval")}
							>
